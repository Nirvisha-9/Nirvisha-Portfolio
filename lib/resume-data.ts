  ...
  experience: [
    {
      ...
      roles: [
        ...
        },
        {
          ...
          location: "Hyderabad, Telangana, India",
          bullets: [
            "Designed and implemented data extraction scripts using Python and SQL to automate repetitive reporting tasks, reducing manual effort by streamlining data workflows.",
            "Collaborated with business analysts to translate functional requirements into technical specifications, bridging the gap between stakeholder needs and data solutions.",
            "Assisted in performance tuning of slow-running database queries, improving report generation efficiency for high-volume transactional datasets.",
            "Contributed to the development of internal data dictionaries and metadata documentation to improve team knowledge management and onboarding.",
            "Monitored data pipeline health and flagged anomalies, supporting proactive issue resolution before impacting downstream reporting.",
          ],
        },
        {
          ...
          location: "Hyderabad, Telangana, India",
          bullets: [
            "Assisted in building and maintaining data pipelines to ingest, transform, and load structured datasets into centralized repositories for downstream analytics.",
            "Wrote Python scripts to automate data extraction and transformation tasks, improving processing speed and reducing manual intervention.",
            "Supported the design of database schemas and optimized SQL queries to ensure efficient data storage and retrieval across reporting systems.",
            "Gained hands-on experience with ETL concepts and tools, contributing to real client data workflows under the guidance of senior engineers.",
            "Documented pipeline logic, data flows, and transformation rules to support team collaboration and maintain data lineage transparency.",
          ],
        },
      ],
    },
